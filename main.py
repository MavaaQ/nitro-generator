...
while True:
    os.system("cls")
    wc.SetConsoleTitle("Nitro Generator & Checker ~ by MavaaQ")
    print(Fore.BLUE, """
 ▐ ▄ .  ▄▄▄▄▄▄▄▄             ▄▄   ▄▄▄ . ▐ ▄      ▌ ▐··▄▄▄▄ 
 █▌▐███  ██  ▀▄ █·.         ▐█ ▀ .▀▄.▀· █▌▐█    .█·█▌.▀·.█▌
▐█▐▐▌▐█· ▐█..▐▀▀▄  ▄█▀▄     ▄█ ▀█▄▐▀▀.▄▐█▐▐▌    ▐█▐█ ▄█▀▀▀ 
            ...
            for i in range(len(nitros)):
                ...
                try:
                    ...
                    if checkurl.status_code in [200, 201, 204]:
                        requests.post(webhook_url, json={"content": f"https://discord.gift/{nitro}", "username": "Nitro Checker - github.com/mavaaq"})
                        count += 1
                        vc.write(nitro + "\n")
